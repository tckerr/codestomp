...
export class CommitGeneratorService {
   ...
   public messages() {
      let custom = [
         ...
         'Thank me later',
         'Thank me later',
         'Something went wrong, reverting commit',
         'Not sure how this even works but I\'m under a deadline',
         `Hotfix for ticket #${Math.floor(Math.random() * 1000)}`];
      let external =
         `
...
changes
(c) Microsoft 1988
Code was clean until manager requested to screw it up
...
fixed mistaken bug
fixed stuff that havent been fixed in last commit
...
freemasonry
Friday 5pm
egotistical bastard. adds expandtab to vimrc
submodule bull
templates... why
YOLO!
...
Merge pull request #67 from Lazersmoke
Merging the merge
minor changes
Minor updates
Misc. fixes
